            ...
            return (
              <div key={index} className='py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
                ...
                <img src={productData.image[0]} className='w-16 sm:w-20' alt='' />
                  ...
                  <p className='px-2 sm:px-3 sm:py-1 border bg-orange-400'>{item.size}</p>
                  </div>
                  </div>
                </div>
          ...
          <div className='flex justify-end my-20'> 
            ...
            <div className='w-full sm:w-[450px]'>
              ...
              <div className='w-full text-end'>
                <button onClick={()=>navigate('/place-order')} className='bg-orange-600 text-white py-3 px-8 text-sm my-8 '>PROCEED TO CHECKOUT</button> 
